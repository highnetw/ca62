      ...
      <div style={{ padding: 20 }}>
        ...
        <div style={{ display: 'flex', gap: 16, justifyContent: 'center', marginBottom: 24 }}>
          ...
          <div style={{ textAlign: 'center' }}>
            <div style={{ width: 90, height: 90, borderRadius: '50%', margin: '0 auto', background: 'var(--navy-bg)', border: '3px solid var(--gold)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 34, fontWeight: 700, color: 'var(--gold)', overflow: 'hidden' }}>
              {m.photo_url
          ...
          {m.recent_photo_url && (
            <div style={{ textAlign: 'center' }}>
              <div style={{ width: 90, height: 90, borderRadius: '50%', margin: '0 auto', background: 'var(--navy-bg)', border: '3px solid #4a9', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 34, overflow: 'hidden' }}>
                <img src={m.recent_photo_url} alt={`${m.name} 최근`} style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
              </div>
